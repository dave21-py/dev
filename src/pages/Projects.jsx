...
function Projects() {
    ...
    const projects = [
        {
            id: 1,
            title: "Alzheimer’s Stage Detection",
            description: "Completed a hybrid deep learning architecture combining MobileNetV2 CNN backbone for feature extraction with multi-head transformer encoder to capture long-range dependecies in MRI scans. Achieved 99.6 test accuracy across 4 stages of dementia. Used custom pytorch dataloaders and real-time image augmentation to prevent overfitting. Finally, implemented Grad-CAM, generating heatmaps to validate that the model correctly focused on specific regions rather than noise, for real time patient diagnosis.",
            mediaType: "image", // "image" or "video"
            mediaSrc: `${import.meta.env.BASE_URL}projects/brain.png`,

            link: "https://github.com/dave21-py/Alzheimers-Transformer"
        },
        {
            id: 2,
